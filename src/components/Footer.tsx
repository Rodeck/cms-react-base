        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                <span className="text-gray-900 font-bold text-xl">JR</span>
              </div>
              <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Profesjonalne usługi budowlane i remontowe. Budujemy i remontujemy
              z pasją od ponad 15 lat. Zaufaj doświadczeniu.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-gray-400 text-sm">Remonty generalne</li>
              <li className="text-gray-400 text-sm">Wykończenia wnętrz</li>
              <li className="text-gray-400 text-sm">Sprzedaż nieruchomości</li>
